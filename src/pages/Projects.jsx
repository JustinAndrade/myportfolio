...
const Projects = () => {
  ...
  return (
    <section id="projects" class="px-4 md:px-0 lg:px-0 mt-10">
      ...
      <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-10 justify-center h-full">
        {/* Card Start */}
        <Fade triggerOnce>
          <div class="md:m-8" style={{ height: "670px" }}>
            <div class="card card-1 rounded overflow-hidden shadow-lg min-h-full transition duration-500 ease-in-out transform hover:-translate-y-1 hover:scale-105">
              <div class="front front-1">
                <div class="flex flex-col mb-12 md:mb-0 justify-center text-center xl:text xl:justify-around items-center mb-4 xl:mb-4">
                  <a
                  ...
                  <a
                    ...
                    target="_blank"
                    rel="noopener noreferrer"
                    class="rounded bg-red-500 text-xs text-gray-200 font-bold mt-1 py-1 px-2 h-6 hover:opacity-75"
                  >
                    See the Code
                  </a>
                </div>
                <div class="px-2 py-4 h-64">
                  <div>
                    <p>
                    ...
                    <div class="px-6 py-10 h-full ">
                      <p>
                        <span class="inline-block bg-gray-200 rounded-full px-3 py-2 mt-2 text-xs font-semibold text-gray-700 mr-2">
                          #Django
                        </span>
                        <span class="inline-block bg-gray-200 rounded-full px-3 py-2 mt-2 text-xs font-semibold text-gray-700 mr-2">
                          #Python
          ...
          <div class="md:m-8" style={{ height: "670px" }}>
            <div class=" card card-2 rounded overflow-hidden shadow-lg min-h-full transition duration-500 ease-in-out transform hover:-translate-y-1 hover:scale-105">
              ...
              <div class="front front-2">
                <div class="px-2 py-4 h-64">
                  <div class="flex flex-col justify-center text-center items-center mb-4 xl:mb-4">
                    <a
            ...
            <div class=" card card-3 rounded overflow-hidden shadow-lg min-h-full transition duration-500 ease-in-out transform hover:-translate-y-1 hover:scale-105">
              ...
              <div class="front front-3">
                <div class="px-2 py-4 h-64">
                  ...
                  <div class="px-6 pb-10 bottom-0 h-64 ">
                    <p>
                      <span class="inline-block bg-gray-200 rounded-full px-3 py-2 mt-2 text-xs font-semibold text-gray-700 mr-2">
                        #Auth0
                      </span>
